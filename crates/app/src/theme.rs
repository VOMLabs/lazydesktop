...
impl Palette {
    /// The default dark palette (Zed-inspired zinc surfaces, one calm accent).
    pub fn dark() -> Self {
        Self {
            dark: true,
            bg: opa(0x18181b),
            panel: opa(0x121215),
            elevated: opa(0x27272a),
            input: opa(0x27272a),
            popover: opa(0x27272a),
            hover: opa(0x1e1e22),
            active: opa(0x26262a),
            selected: opa(0x2c2c31),
            focus_ring: with_alpha(0x16a34a, 0x66),
            border: opa(0x2e2e32),
            separator: opa(0x252529),
            text_primary: opa(0xededef),
            text_secondary: opa(0xb4b4bc),
            text_muted: opa(0x8e8e93),
            accent: opa(0x16a34a),
            accent_hover: opa(0x22c55e),
            accent_active: opa(0x15803d),
            accent_foreground: opa(0xffffff),
            accent_selected: with_alpha(0x16a34a, 0x16),
    ...
    pub fn light() -> Self {
        Self {
            ...
            focus_ring: with_alpha(0x15803d, 0x4d),
            border: opa(0xd7dce4),
            ...
            accent: opa(0x15803d),
            accent_hover: opa(0x16a34a),
            accent_active: opa(0x166534),
            accent_foreground: opa(0xffffff),
            accent_selected: with_alpha(0x15803d, 0x14),
