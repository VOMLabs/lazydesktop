...
impl Palette {
    ...
    pub fn dark() -> Self {
        Self {
            ...
            focus_ring: with_alpha(0x3b82f6, 0x66),
            border: opa(0x2e2e32),
            ...
            accent: opa(0x3b82f6),
            accent_hover: opa(0x5b93f7),
            accent_active: opa(0x2563eb),
            accent_foreground: opa(0xffffff),
            accent_selected: with_alpha(0x3b82f6, 0x16),
